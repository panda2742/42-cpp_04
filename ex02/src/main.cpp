...
void printAnimal(AAnimal *animal)
{
...
int main(void)
{
	...
	std::cout << DEBUG_C1 "----- ➙ We try to instanciate an AAnimal... ----------" RESET << std::endl;
	// AAnimal*	itDoesNotWork = new AAnimal();
